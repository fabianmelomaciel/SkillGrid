...
- 2026-07-10 - Frontend Design Intelligence — PM ahora detecta automáticamente trabajo frontend/UI (landing, dashboard, panel, refactor visual, animación) y delega en paralelo a impeccable-design-taste, emil-kowalski-design, github-premium-aesthetics, creativo-visual según el tipo de tarea. Señales: keywords, extensiones (.html, .jsx, .tsx, .vue, .css, etc.), tipos de página, triggers de diseño/refactor. Skills fuente: `skills/project-manager/SKILL.md`, `~/.config/opencode/skills/project-manager/SKILL.md`, `~/.config/opencode/agents/project-manager.md`.
