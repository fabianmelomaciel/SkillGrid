...
description: Manages secure, sandboxed execution runtimes (like Docker, WASM, or microVMs) to safely run untrusted code, tests, and scripts generated by agents.
category: agent
status: stable
risk_level: critical
---
