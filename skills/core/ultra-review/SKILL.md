...
### Prompt Compaction
When invoking flash subagents, write concise prompts outlining the review checklist to keep context overhead low.

[model:gemini-1.5-pro]
### Deep Auditing
Pro models excel at understanding complex multi-file flows. Use them for the Security and Performance audits.
...
If using Claude Code, you can combine this skill with the native `/review` tool to automate local diff checks.
