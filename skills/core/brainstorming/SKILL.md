...
status: stable
risk_level: safe
token_estimate: { input: 3054, output: 1222 }
---
...
6. **Write design doc** — save to `docs/SkillGrid/specs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `docs/SkillGrid/specs/YYYY-MM-DD-<topic>-design.md`
