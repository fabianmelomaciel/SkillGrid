...
Choose and implement exactly one structural family from [layout-archetypes.md](file:///c:/laragon/www/OpenSkills/skills/design/impeccable-design-taste/references/layout-archetypes.md):
...
You must run all 6 layers of check from [design-audit-checklist.md](file:///c:/laragon/www/OpenSkills/skills/design/impeccable-design-taste/references/design-audit-checklist.md) before outputting code:
...
*   **Layer 5: Motion & Interaction**: Duration <=300ms, transform/opacity only, active-press feedback, no `<img>` hover scale (see [motion-patterns.md](file:///c:/laragon/www/OpenSkills/skills/design/impeccable-design-taste/references/motion-patterns.md)).
